defmodule MilosTraining.Repo.Migrations.ScopeWeeklyLeaderboardByOrganization do
  use Ecto.Migration
  ...
  def down do
    raise "weekly_leaderboard organization scoping is not automatically reversible"
  end
end
