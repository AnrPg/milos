defmodule MilosTraining.Repo.Migrations.MakeFinanceAggregatesReversalAware do
  use Ecto.Migration
  ...
  def down do
    raise "finance aggregate reversal-aware projection is not automatically reversible"
  end
end
